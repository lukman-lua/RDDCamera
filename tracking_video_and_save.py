...
output_video_path = "video/0300713R1_tracking.mp4"  # Output video path
...
while True:
    ...
    if not success:
        print("Video selesai, keluar dari program.")
        break  # Berhenti jika tidak ada frame lagi yang dibaca

    # Proses deteksi dan pelacakan dengan YOLO menggunakan model.track()
    results = model.track(
        frame, 
        conf=0.4, 
        iou=0.4, 
...
print(f"Hasil deteksi dan pelacakan disimpan ke: {output_video_path}")
