...
from rdd.inspection import save_cracks, create_inspection, update_inspections, create_inspection_folder
...
def save_frame_to_assets(frame, filename, inspection_folder):
    ...
    assets_folder = os.path.join(
        os.getcwd(),
        'assets/inspections/nth_all_predict'
    )
...
def generate_frames():
    ...
    while True:
        ...
        results = model.predict(frame, conf=0.4, iou=0.4)
